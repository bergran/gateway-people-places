...
# ~~~~~ APP ~~~~~
PROJECT_NAME = os.getenv('PROJECT_NAME', 'Gateway')
...
PLACES_MICROSERVICES = os.getenv('PLACES_MICROSERVICES', 'http://localhost:8081')
PEOPLE_MICROSERVICES = os.getenv('PEOPLE_MICROSERVICES', 'http://localhost:8082')

# RESOURCE ORIGIN

RESOURCE_ORIGIN = os.getenv('RESOURCE_ORIGIN', 'http://localhost:8000')
